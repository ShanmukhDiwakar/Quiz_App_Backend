$(document).ready(function () {
  ...
  $("#homeBtn").click(function () {
    window.location.href = "localhost:3000"; // Change 'index.html' to the actual starting page URL
  });
  ...
  $("#quizBtn").click(function () {
    window.location.href = "localhost:3000/student/quiz"; // Redirect to quiz.html
  });
